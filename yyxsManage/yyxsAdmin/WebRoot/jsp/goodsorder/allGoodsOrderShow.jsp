...
<html lang="en">
	...
	<body>
		<c:set var="fail_order_status"
			value="<%=YYXSAdminConstant.FAIL_ORDER_STATUS %>"></c:set>
		<c:set var="to_processed_order_status"
			value="<%=YYXSAdminConstant.TO_PROCESSED_ORDER_STATUS %>"></c:set>
		<c:set var="to_send_goods_order_status"
			value="<%=YYXSAdminConstant.TO_SEND_GOODS_ORDER_STATUS %>"></c:set>
		<c:set var="has_sent_goods_order_status"
			value="<%=YYXSAdminConstant.HAS_SENT_GOODS_ORDER_STATUS %>"></c:set>
		<c:set var="has_completed_order_status"
			value="<%=YYXSAdminConstant.HAS_COMPLETED_ORDER_STATUS %>"></c:set>
		<div id="pageTop"></div>
										...
										<div class="input-group" style="margin-top: 10px">
											...
											<div class="input-group-btn">
												...
												<ul class="dropdown-menu" role="menu">
													<li>
														<a id="option1" href="javascript:void(0)">商品名称</a>
													</li>
													<li>
											...
											<form id="searchForm" action="/goodsorder/searchOrder.html" method="post">
												...
												<input id="searchWords" name="searchWords" type="text" class="form-control" value="${searchWords}" placeholder="Search for...">
											</form>
						...
						<div class="panel-body">
							<table class="table">
								...
								<c:forEach var="goodsorder" items="${goodsOrderList}">
									<tr>
										<td
											style="width: 13%; table-layout: fixed; word-break: break-all; overflow: hidden;">
											<a href="javascript:void(0)" name="goodsNameBtn"
												goodsid="${goodsorder.goid}">${goodsorder.good_name}</a>
										</td>
										<td
											style="width: 10%; table-layout: fixed; word-break: break-all; overflow: hidden;">
										...
										<td
											style="width: 15%; table-layout: fixed; word-break: break-all; overflow: hidden;">
										...
										<td
											style="width: 20%; table-layout: fixed; word-break: break-all; overflow: hidden;">
											${goodsorder.systime}
										</td>
										<td>
											<a
												href="/goodsorder/goodsOrderInfoUpdateShow.html?orderId=${goodsorder.goid}&currentPage=${currentPage}"
		...
		<div id="scorllxDiv" style="display: none;">
			<a href="javascript:void(0);"
				style="font-size: 70px; text-decoration: none; outline: none;"
				id="scrollxBtn" lang="#pageBottom"
